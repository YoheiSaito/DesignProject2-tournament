...
bool Board::to_command(Command& cmd, int turn, Board_p after){
	...
	if( pay ){
		...
		std::string src = {(char)('D'+ turn), (char)( i+'1')};
		std::string dst = {(char)(ws[0] +'A'), (char)(hs[0] +'1')};
		...
		std::string src = {(char)('A'+ srx), (char)( sry+'1')};
		std::string dst = {(char)(dsx +'A'), (char)(dsy +'1')};
